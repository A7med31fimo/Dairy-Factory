@extends('layouts.app')
@section('title', 'تسجيل توزيع جديد')

@section('content')
<div class="page-header">
    <h1><i class="bi bi-truck"></i> تسجيل توزيع جديد</h1>
    <a href="{{ route('distribution.index') }}" class="btn btn-outline-secondary">
        <i class="bi bi-arrow-right me-1"></i> رجوع
    </a>
</div>

<form method="POST" action="{{ route('distribution.store') }}" id="distForm">
    @csrf
    <div class="row g-3">
        <!-- Main Info -->
        <div class="col-12">
        ...
        <div class="col-12">
            <div class="d-flex gap-3">
                <button type="submit" class="btn btn-primary btn-lg flex-fill">
                    <i class="bi bi-floppy-fill me-2"></i> حفظ التوزيع
                </button>
                <a href="{{ route('distribution.index') }}" class="btn btn-outline-secondary btn-lg">إلغاء</a>
            </div>
        </div>
    </div>
</form>
            ...
            <div class="row g-2 align-items-end">
                <div class="col-12 col-md-4">
                    ...
                    <input type="text" name="items[${idx}][product_name]"
                           ...
                           placeholder="مثال: حليب كامل الدسم" required>
                </div>
                ...
                <div class="col-8 col-md-1">
                    ...
                    <div class="form-control form-control-sm text-center fw-bold subtotal-display"
                         id="sub-${idx}"
                         style="background: #e8f0fa; color: #2565AE;">0</div>
                </div>
